<template>
    <div class="header-bar">
        ...
        <ul class="nav">
            <li><router-link style="color: #2384E8" to="{}">电影</router-link></li>
            <li><router-link style="color: #9F7860" to="{}">图书</router-link></li>
            <li><router-link style="color: #E4A813" to="{}">广播</router-link></li>
            <li><router-link style="color: #2AB8CC" to="{}">小组</router-link></li>
        </ul>
